...
function renderPageContent(id){
  ...
  if(page==='dashboard'){el.innerHTML=portalRole==='entity-admin'?buildEntityAdminDashboardHTML():(portalRole==='super-admin'?buildSuperAdminDashboardHTML():dashboardContentHTML);return;}
